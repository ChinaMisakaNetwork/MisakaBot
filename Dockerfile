...
RUN apt update && apt install git -yqq && git clone https://github.com/ChinaMisakaNetwork/MisakaBot.git && install_depend.sh && install.sh && cp MisakaBot /MisakaBot_exec/
